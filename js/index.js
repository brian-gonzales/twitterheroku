...
(function(C, p) {
  ...
  var D = "",
    ...
    L = {
      fetch: function(a) {
        void 0 === a.maxTweets && (a.maxTweets = 50);
...
$(document).ready(function() {
  var retardo = 5000;
  var animacion = 400;
  var interval = setInterval(changeDiv, retardo);
  //  $("#twitterida li:gt(2)").hide();
  function changeDiv() {
    $("#twitterida li:nth-child(1)").animate({
      opacity: "toggle"
    }, animacion, "linear", function() {
      $("#twitterida li:nth-child(1)").appendTo("#twitterida ul");
      $("#twitterida li:last-child").animate({
        opacity: "toggle"
      }, animacion);
    });
  }
